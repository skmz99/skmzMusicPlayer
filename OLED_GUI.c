...
void GUI_Show(void)
{
    ...
    GUI_DisString_EN(30, 25, "WaveShare ", &Font16, FONT_BACKGROUND, WHITE);
    GUI_DisString_EN(28, 35, "Electronic", &Font16, FONT_BACKGROUND, WHITE);
    GUI_DisString_EN(22, 45, "1.3inch OLED", &Font16, FONT_BACKGROUND, WHITE);
